...
The sources for ``jelinekstat`` can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/eamontoyaa/jelinekstat
.. _tarball: https://github.com/eamontoyaa/jelinekstat/tarball/master
